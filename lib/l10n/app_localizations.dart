...
abstract class AppLocalizations {
  ...
  /// No description provided for @gpsOffTitle.
  ///
  /// In en, this message translates to:
  /// **'GPS is turned off'**
  String get gpsOffTitle;

  /// No description provided for @gpsOffBody.
  ///
  /// In en, this message translates to:
  /// **'Enable location services to start tracking.'**
  String get gpsOffBody;
  ...
  /// No description provided for @fixTimeoutMessage.
  ///
  /// In en, this message translates to:
  /// **'Still searching for a GPS fix — try moving to an open area.'**
  String get fixTimeoutMessage;

  /// No description provided for @lowAccuracyWarning.
  ///
  /// In en, this message translates to:
  /// **'Low accuracy — signal may be obstructed'**
